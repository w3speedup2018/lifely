...
class VariantSelects extends HTMLElement {
  ...
  updateMedia() {
    ...
    const curent_feture = 'Slide-'+ this.dataset.section +'-'+this.currentVariant.featured_media.id;
    var slide = document.getElementById(curent_feture).parentElement.parentElement.getAttribute('data-slick-index');
    $('#productSliderGallery').slick('slickGoTo',slide);
    ...
    if ($(window).width() < 767) {
      $('html, body').animate({
          scrollTop: $(".product-sec-main").offset().top
      }, 1500);
    }
  }
